...
preparing students for the A2 Key and A2 Key for Schools examinations.
...
website: [http://www.englishprofile.org](http://www.englishprofile.org)

##### Organisation of the list

- **Word sets**
Some categories of words that a learner at this level might be expected to know, e.g. days
of the week, are now included in the alphabetical list and in Appendix 1 (2025 update).
Although ‘grammar words’ (pronouns, modal verbs, etc.) are included, the Language
Specifications section of the Key and Key for Schools Handbooks (available from
[http://www.cambridgeenglish.org)](http://www.cambridgeenglish.org)) should be consulted for a more complete listing.
- **Exemplification**
Example phrases and sentences showing how words might be used are given only where
words with different meanings need to be constrained. For example, _bank_ is followed by ‘I
changed my money in a bank’ – this shows that _bank_ is limited to the idea of a financial
institution: candidates are not expected to know other meanings, such as ‘a river bank’.

© UCLES 2025 Page 2 of 31 A2 Key and Key for Schools
...
meaning is transparent), e.g. _sit down_ , _go out_ and ‘non-literal’ verbs, e.g. _look after_ , _get up_.
- **Topic lists**
In Appendix 2, words have been grouped together under common Key and/or Key for
Schools themes, such as ‘Food and Drink’, ‘House and Home’ and ‘Sport’. All the
words in the Topic Lists headings now appear on the wordlist (2025 update).
...
- The list does not include every word that may appear on a A2 Key or A2 Key for
    Schools paper.
- The list covers receptive and productive vocabulary.
- The list is updated regularly.

© UCLES 2025 Page 3 of 31 A2 Key and Key for Schools


```
© UCLES 202 5 Page 4 of 32 A2 Key and Key for
Schools
```
## A
...
```
© UCLES 202 5 Page 5 of 32 A2 Key and Key for
Schools
```
at / @ **(prep)**
...
bit **(n & adv)**
- Just a little bit of cake, please.
...
```
© UCLES 202 5 Page 6 of 32 A2 Key and Key for
Schools
```
...
- birthday card
- credit card
- card game (e.g. We played a card game
in class.)
career **(n)**
careful **(adj)**
- Be careful!
...
```
© UCLES 202 5 Page 7 of 32 A2 Key and Key for
Schools
```
cereal **(n)**
certainly **(adv)**
...
chair **(n)**
change **(v & n)**
- There is a change of room for this
course.
channel **(n)**
character **(n)**
- He was my favourite character in the
film.
chat **(n)**
chatroom **(n)**
cheap **(adj)**
...
child **(n)**
chilli **(n)**
chips **(n pl) (Br Eng) (Am Eng:** biscuit **)**
- egg and chips
chocolate **(n)**
choose **(v)**
cinema **(n)**
...
```
© UCLES 202 5 Page 8 of 32 A2 Key and Key for
Schools
```
- a main course
- of course (not)
...
- I broke a dish when I was doing the
washing up.
dive **(v)**
- I learnt to dive at the swimming pool.
diving **(adj)**
- I’ve j oined a diving club.
do **(av & v)**
doctor **(n)**
document **(n)**
dog **(n)**
...
```
© UCLES 202 5 Page 9 of 32 A2 Key and Key for
Schools
```
internet.
downstairs **(adv)**
...
drive **(v)**
driver **(n)**
driving/driver’s licence **(n) (Br Eng) (Br Eng:**
driver’s license **)**
drop **(v)**
...
```
© UCLES 202 5 Page 10 of 32 A2 Key and Key for
Schools
```
...
folder **(n)**
follow **(v)**
follow (SOCIAL MEDIA) **(v)**
- follow somebody on social media
food **(n)**
foot **(n)**
- my right foot
football **(n)**
...
```
© UCLES 202 5 Page 11 of 32 A2 Key and Key for
Schools
```
game **(n)**
garage **(n)**
...
```
© UCLES 202 5 Page 12 of 32 A2 Key and Key for
Schools
```
heart **(n)**
heating **(n)**
...
```
© UCLES 202 5 Page 13 of 32 A2 Key and Key for
Schools
```
jumper **(n)**
June **(n)**
...
- The answer key is at the back of the
book.
keyboard **(n)**
...
lend **(v)**
length **(n)**
- The length of the lesson/journey was 50
minutes.
...
```
© UCLES 202 5 Page 14 of 32 A2 Key and Key for
Schools
```
look **(v)**
...
- a member of a club
memory **(n)**
- My computer has 100 GB of memory.
menu **(n)**
message **(n, v)**
metal **(n & adj)**
...
```
© UCLES 202 5 Page 15 of 32 A2 Key and Key for
Schools
```
mouse **(n)**
...
```
© UCLES 202 5 Page 16 of 32 A2 Key and Key for
Schools
```
out **(adv)**
outdoor **(adj)**
...
password **(n)**
past **(prep & n)**
- In the past, people didn’t have laptops.
...
```
© UCLES 202 5 Page 17 of 32 A2 Key and Key for
Schools
```
point **(v)**
polar bear **(n)**
...
- football practice
practise **(v)**
- You must practise if you want to play
well.
...
recipe **(n)**
record **(v)**
- T hey’re recording a new album.
red **(adj)**
refrigerator **(n)**


```
© UCLES 202 5 Page 18 of 32 A2 Key and Key for
Schools
```
relax (become happy) **(v)**
relaxing **(adj)**
remember **(v)**
rent **(v)**
repair **(v)**
...
share (digitally) **(v)**
- She shared her pictures online.
shark **(n)**
she **(pron)**
sheep **(n)**
sheet **(n)**
...
```
© UCLES 202 5 Page 19 of 32 A2 Key and Key for
Schools
```
- a bed sheet
- a sheet of paper
...
- He wanted to go but he didn’t say so.
    **(adv)**
soap **(n)**
soccer **(n)**
social media **(n)**
...
- Sorry to hear you’re not we ll.
sort **(n)**
sound **(v)**
- That sounds nice.
- To sound good/interesting/strange, etc.
soup **(n)**
south **(n, adj & adv)**
space **(n)**
spare **(adj)**
...
```
© UCLES 202 5 Page 20 of 32 A2 Key and Key for
Schools
```
sports centre **(n)**
spring **(n)**
...
sugar **(n)**
suggest **(v) + ing**
- I suggest having the meeting in the
office.
suit **(n)**
...
```
© UCLES 202 5 Page 21 of 32 A2 Key and Key for
Schools
```
technology **(n)**
teenager **(n)**
...
traffic light **(n)**
train **(n)**
train (transitive and intransitive) **(v)**
- sport
training (transitive and intransitive) **(n)**
- sport
trainer **(n)**
- a pair of trainers
tram **(n)**
...
```
© UCLES 202 5 Page 22 of 32 A2 Key and Key for
Schools
```
understand **(v)**
unfortunately **(adj)**
...
```
© UCLES 202 5 Page 23 of 32 A2 Key and Key for
Schools
```
wood **(n)**
wooden **(adj)**
...
